# Generated by Django 2.2.8 on 2020-09-05 14:18
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_name', models.CharField(blank=True, max_length=50, null=True, verbose_name='Username')),
                ('email', models.CharField(blank=True, max_length=40, null=True, verbose_name='Email')),
                ('description', models.TextField(verbose_name='Genis mezmunu')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('is_published', models.BooleanField(default=True, verbose_name='is published')),
